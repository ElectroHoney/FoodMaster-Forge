...
public class AgerBlockScreen extends AbstractContainerScreen<AgerBlockMenu> {
    ...
    private void assignFluidRenderer() {
        renderer = new FluidStackRenderer(AgerBlockEntity.AGER_MAX_FLUID_CAPACITY, true, 12, 34);
    }
...
//          //x and y of arrow, offset of arrow progress, vertical offset of progress, width of image, height of image
    ...
    private void drawFluid(PoseStack poseStack, final int width, final int height, FluidStack fluidStack) {
        ...
        long scaledAmount = (amount * height) / AgerBlockEntity.AGER_MAX_FLUID_CAPACITY;
