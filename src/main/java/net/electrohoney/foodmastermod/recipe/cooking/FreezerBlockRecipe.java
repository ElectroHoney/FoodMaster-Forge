...
public class  FreezerBlockRecipe implements Recipe<SimpleContainer> {
//    @todo I have to modify the recipe so its not shapeless
    ...
    public FreezerBlockRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems, int minTemperature, int maxTemperature, FluidStack fluidStack, Ingredient tool) {
        this.id = id;
        this.output = output;
    ...
    public boolean matches(SimpleContainer pContainer, Level pLevel) {
        ...
        if(!tool.test(pContainer.getItem(FreezerBlockEntity.UTENSIL_SLOT_ID))){
            return false;
        }
    ...
    public static class Type implements RecipeType<FreezerBlockRecipe>{
        private Type(){}
    ...
    public static class Serializer implements RecipeSerializer<FreezerBlockRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(FoodMaster.MOD_ID,"freezing");

        @Override
        public FreezerBlockRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new FreezerBlockRecipe(id, output, inputs, minTemperature, maxTemperature, fluidStack1, tool);
        }

        @Override
        public FreezerBlockRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, FreezerBlockRecipe recipe) {
