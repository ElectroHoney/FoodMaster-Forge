...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<SmokerBlockRecipe>> SMOKER_SMOKING_SERIALIZER =
            SERIALIZERS.register("smoking", ()-> SmokerBlockRecipe.Serializer.INSTANCE);
